...
entire processed frames. First column shows the feature initial point
with its initial value removed. All feature initialized at $1^{st}$
frame has a stable initialization coordinate with little variation.
Second column shows the feature angle parameters with their initial
value removed. Third column shows the angle parameters with their mean
value removed, which shows a clearer variation pattern of these two
angles.
