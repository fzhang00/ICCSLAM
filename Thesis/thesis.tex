...
\usepackage[masters,3committee,standard,nonsequential]{cuthesis}
\usepackage{array}
\usepackage{graphicx}
\usepackage{cite}
...
\title{Obstacle Detection Using Monocular Camera for Low Flying
  Unmanned Aerial Vehicle}
% Name used must be name under which you are registered at Carleton University
\author{Fan Zhang}
\pastdegrees{B.Sc.}
\dept{Systems and Computer Engineering}
\degreename{Master of Applied Science in Electrical and Computer Engineering}
% Specify your Thesis Submission Date
\submitdate{December 2014} \copyrightyear{2014} \copyrightmonth{December}
...
%\supervisor{Dr. Rafik Goubran, Co-supervisor}
%\supervisor{Professor Paul Straznicky, Co-supervisor}
\firstcommittee{Dr. Rafik Goubran, Thesis Co-supervisor}
\secondcommittee{Professor Paul Straznicky, Thesis Co-supervisor}
%\thirdcommittee{A. Mack}
%\fourthcommittee{B. Donner}
% Specify department chair
\departmentchair{Roshdy Hafez, Department Chair, \\Department of
...
\appendix
\newappendix{appendix}
\newappendix{appendix2}
\newappendix{appendix3}
%\printbibliography
\end{document}
