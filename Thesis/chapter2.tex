...
% word checked
Camera model relates measurement on image plane to measurement of
...
The prediction and correction cycles can then be carried out
following the standard EKF algorithm. The landmarks are generally
...
bound determined by the errors when the first observation was made.
