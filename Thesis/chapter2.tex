...
% & $\hat{x}^-_k=A\hat{x}^+_{k-1}+B\mu_{k-1}$ & \stepcounter{equation}\tag{\theequation}\\
% & $P^-_k = AP^+_{k-1}A^T+Q$ & \stepcounter{equation}\tag{\theequation}\\
% \hline
% \multirow{3}{*}{Correction}
% & $K_k=P^-_kH^T(HP^-_kH^T+R)^{-1}$  & \stepcounter{equation}\tag{\theequation}\\
% & $\hat{x}^+_k = \hat{x}^-_k+K_k(z_k-H\hat{x}^-_k)$ & \stepcounter{equation}\tag{\theequation}\\
% & $P^+_k = (I-K_kH)P^-_k$ & \stepcounter{equation}\tag{\theequation}\\
% \hline
% \end{tabular}
% \end{table}
% \FloatBarrier
...
% \hline
% \multirow{2}{*}{Prediction} 
% & $\hat{x}^-_k=f(\hat{x}^+_{k-1},\mu_{k-1},0)$ & \stepcounter{equation}\tag{\theequation}\\
% & $P^-_k = A_kP^+_{k-1}A_k^T+W_kQ_{k-1}W_k^T$ & \stepcounter{equation}\tag{\theequation}\\
% \hline
% \multirow{3}{*}{Correction}
% & $K_k=P^-_kH_k^T(H_kP^-_kH_k^T+V_kR_kV_k^T)^{-1}$  & \stepcounter{equation}\tag{\theequation}\\
% & $\hat{x}^+_k = \hat{x}^-_k+K_k(z_k-h(\hat{x}^-_k,0))$ & \stepcounter{equation}\tag{\theequation}\\
% & $P^+_k = (I-K_kH)P^-_k$ & \stepcounter{equation}\tag{\theequation}\\
% \hline
% \end{tabular}
% \end{table}
