...
These result shows that the importance of analysis of cross
correlation between landmark estimates in a SLAM problem. 
...
As defined in \cite{huang_analysis_2008}, a state estimator is consistent
...
consistency of nonlinear two-dimentional EKF based SLAM problem, and
conclude:
